...
public abstract class AbstractRepositoryGenerator extends AbstractGenerator {

	private static final Logger log = LoggerFactory.getLogger(AbstractRepositoryGenerator.class);
