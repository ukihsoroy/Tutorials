 ...
 * @author K.O
 */
public class OdpsDataSource extends ConnectionPropertiesImpl implements DataSource, Referenceable, Serializable {

    private static final String url = "jdbc:odps:https://service.odps.aliyun.com/api?project=%s";
    ...
    public java.sql.Connection getConnection(String project) throws SQLException {
        return DriverManager.getConnection(String.format(url, project), accessId, accessKey);
    }
    ...
    public Reference getReference() throws NamingException {
        String factoryName = "io.ukihsoroy.automation.source.odps.OdpsDataSourceFactory";
